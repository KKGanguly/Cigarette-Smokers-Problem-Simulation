...
public class SmokerWithMatch extends Smoker implements Runnable {
	public SmokerWithMatch(Semaphore tobaccoSem, Semaphore paperSem,
	...
	public void makeCigarette() {
		...
		if (Main.control) {
			try {
				...
				Date date = new Date();
				Main.bw.write("Smoker with match making cigarette "+dateFormat.format(date));
				Main.bw.newLine();
				Main.bw.flush();
			...
			Interface.imageLabel3.setIcon(new ImageIcon("smoker.png"));
			Interface.fig3.setText("Smoking");
